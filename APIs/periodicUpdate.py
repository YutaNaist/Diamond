...
class PeriodicUpdate:
    ...
    def __init__(self, logger=None, dict_Environment_Variable={}):
        ...
        self.dict_Periodic_Execution_Time = {
            "hour": 10,
            "minute": 20,
            "second": 0
        }
    ...
    def setStartConditionAndInterval(self, periodicExecutionTime,
                                     periodicInterval):
    ...
    def setFilePathOfJsonDatabase(self, filePathOfJsonDatabase,
                                  filePathOfAllIds):
    ...
    def runSchedule(self):
        ...
        while True:
            try:
                ...
                intNextInterval = self.int_Periodic_Interval - self.floatExecutingTime // 1
                self.floatExecutingTime = self.floatExecutingTime - self.floatExecutingTime // 1
                schedule = sched.scheduler()
                schedule.enter(
                    intNextInterval,
                    1,
    ...
    def updateJsonDatabase(self):
        ...
        json.dump(self.list_Temp_Generate_ID,
        ...
        if is_Update is True:
            ...
            for proposal in proposals:
                ...
                if not (id in IDs) and id != "":
                    ...
                    dict_Proposal["is_used_now"] = dict_old_proposal[
                        "is_used_now"]
                    dict_Proposal["is_finished"] = dict_old_proposal[
                        "is_finished"]
                # proposal.saveSingleProposal(base_Path + id + ".json_prop")
                json.dump(dict_Proposal,
