...
def make_logger(dict_Environment_Variable):
    log_config = json.load(open("log_config_periodic.json", mode="r"))
...
google_auth_setting_yaml_filename = (
    dict_Environment_Variable["database_directory"]
    + dict_Environment_Variable["setting_yaml_google_drive_api"]
)
google_auth_setting_yaml = yaml.load(
    open(google_auth_setting_yaml_filename, mode="r"), Loader=yaml.SafeLoader
)
google_auth_setting_yaml["client_config_file"] = (
    dict_Environment_Variable["database_directory"]
    + "/Google_API_Keys/Certificate-Drive.json"
)

# print(google_auth_setting_yaml)
yaml.safe_dump(
    google_auth_setting_yaml,
